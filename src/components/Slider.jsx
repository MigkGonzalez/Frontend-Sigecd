  ...
  render() {
    return (
      <div id="slider">
        ...
        <h6>“Si trabajas, los resultados vendrán solos. No hago las cosas a medias, porque sé que si lo hago entonces sólo puedo esperar tener resultados a medias” - Michael Jordan"</h6>
